...
QT_MOC_LITERAL(1, 9, 13), // "sendMsgToMain"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MyThread\0sendMsgToMain\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::sendMsgToMain)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::sendMsgToMain(QString _t1, int _t2)
{
